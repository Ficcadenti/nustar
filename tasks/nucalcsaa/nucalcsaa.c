...
#define NUCALCSAA_C
#define NUCALCSAA_VERSION	"0.1.3"
...
int nucalcsaa_work()
{
    ...
    if( strcasecmp(global.par.evtexpr,"NONE") )
    {
        ...
        headas_chat(NORMAL, "%s: Info: Creating filtered '%s' temporary event file.\n", global.taskname, global.tmp.fsel_outfile);
...
int ReadSAAParInfo(char *filename, SAAParInfo_t *saaparinfo) {
    ...
    } /* End SAA Ext Sessione */
    
    { /* TENTACLE Ext Sessione */
    ...
    } /* End TENTACLE Ext Sessione */
    
    { /* SAANEW Ext Sessione */
      headas_chat(NORMAL,"%s: Info: SAANEW Ext Sessione '%s'\n", global.taskname,KWVL_EXTNAME_SAANEW);
    ...
    } /* End SAANEW Ext Sessione */
    
    { /* TENTACLENEW Ext Sessione */
	/* Move in SAANEW extension in input file */
